...
class ReferenceGenerator {
 public:
  ...
  bool UpdateRouteSub(std::vector<carla::SharedPtr<carla::client::Waypoint>> &wpVec);
  bool UpdateRouteCMPF(const cmpf_msgs::Route::ConstPtr &path) ; 
...
//#else
static bool RetriveReferenceLineCMPF(ReferenceLine &ref_lane,
                                              const vehicle_state::KinoDynamicState &vehicle_state,
                                              const cmpf_msgs::Route &lane,
                                              double lookahead_distance,
                                              double lookback_distance,
                                              bool smooth = false,
                                              const ReferenceLineConfig &smooth_config = ReferenceLineConfig());
