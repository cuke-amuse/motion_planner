...
namespace GRANSAC {
    ...
    public:
        ...
        Evaluate(const std::vector<std::shared_ptr<AbstractParameter>> &EvaluateParams, VPFloat Threshold) = 0;
        virtual std::array<std::shared_ptr<AbstractParameter>, t_NumParams> GetModelParams(void) const
